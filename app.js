...
document.addEventListener('click', function(e) {
  if (!_polyActivePopover) return;
  var pop = document.getElementById('poly-pop-' + _polyActivePopover);
  if (pop && !pop.contains(e.target)) polyClosePopover(_polyActivePopover);
});
